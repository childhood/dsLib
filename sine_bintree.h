...
typedef int (*btree_inorder_func)(BTREE_CTX*, BTREE_NODE_T*, void*);
/* RETURN: should return 0 on success */
typedef int (*btree_postorder_func)(BTREE_CTX*, BTREE_NODE_T*, void*);
/* RETURN: should return 0 on success */
typedef int (*btree_preoorder_func)(BTREE_CTX*, BTREE_NODE_T*, void*);
